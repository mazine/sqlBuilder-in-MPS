...
public class Column extends BaseConcept implements IValidIdentifier {
  public static final String concept = "mazin.sqlBuilder.structure.Column";
  ...
  public Type getType() {
    return (Type) this.getChild(Type.class, Column.TYPE);
  }
  ...
  public static Column newInstance(SModel sm, boolean init) {
    return (Column) SModelUtil_new.instantiateConceptDeclaration("mazin.sqlBuilder.structure.Column", sm, GlobalScope.getInstance(), init).getAdapter();
  }
